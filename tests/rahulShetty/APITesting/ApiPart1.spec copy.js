...
test.beforeAll('Login via UI', async ({ browser }) => {
    ...
    // Inject that session storage into our global webcontext var and use it everywhere
...
test('Next steps', async () => {
    ...
    // Now we won't have to login, we are injecting the session
